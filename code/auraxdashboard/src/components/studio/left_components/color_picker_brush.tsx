...
import { setBrushColor, setBrushOpacity } from "@/redux/features/studioSlice";
        ...
        <div className="p-4 max-w-[240px]">
            ...
            <div>
                <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-sm">{brush.opacity}%</span>
                </div>
                <Slider
                    min={0}
                    max={100}
                    value={[brush.opacity]}
                    onValueChange={(value) => dispatch(setBrushOpacity(value[0]))}
